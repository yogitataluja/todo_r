!(function (t) {
    ...
    (e.prototype.init = function () {
        t("#sa-basic").on("click", function () {
            Swal.fire({ title: "Any fool can use a computer", confirmButtonColor: "#5b73e8" });
        }),
            t("#sa-title").click(function () {
                Swal.fire({ title: "The Internet?", text: "That thing is still around?", icon: "question", confirmButtonColor: "#5b73e8" });
            }),
            t("#sa-success").click(function () {
                Swal.fire({ title: "Notification Sent", icon: "success",  confirmButtonColor: "#5b73e8" });
            }),
            ...
            t("#sa-image").click(function () {
                Swal.fire({ title: "Sweet!", text: "Modal with a custom image.", imageUrl: "assets/images/logo-dark.png", imageHeight: 20, confirmButtonColor: "#5b73e8", animation: !1 });
            }),
            ...
            t("#custom-padding-width-alert").click(function () {
                Swal.fire({ title: "Custom width, padding, background.", width: 600, padding: 100, confirmButtonColor: "#5b73e8", background: "#fff url(//subtlepatterns2015.subtlepatterns.netdna-cdn.com/patterns/geometry.png)" });
            }),
            t("#ajax-alert").click(function () {
                Swal.fire({
                    ...
                    Swal.fire({ icon: "success", title: "Ajax request finished!", html: "Submitted email: " + t });
                });
            }),
            t("#chaining-alert").click(function () {
                Swal.mixin({ input: "text", confirmButtonText: "Next &rarr;", showCancelButton: !0, confirmButtonColor: "#5b73e8", cancelButtonColor: "#74788d", progressSteps: ["1", "2", "3"] })
